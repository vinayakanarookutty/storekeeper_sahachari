  ...
  const uploadImages = async () => {
    ...
    try {
      ...
      for (const imageUri of selectedImages) {
        ...
        const { url: presignedUrl, key }: PresignedUrlResponse =
      ...
      showAlert(
        "Success",
        `${imageKeys.length} image(s) uploaded successfully!`,
      );
    } catch (error: any) {
  ...
  const handleCreateService = async () => {
    ...
    try {
      ...
      if (
        ...
        Array.isArray(currentUser.serviceablePincodes)
      ) {
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity
          ...
          disabled={
            createServiceMutation.isPending || uploadedImageKeys.length === 0
          }
        >
